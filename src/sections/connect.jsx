...
const Connect = () => {
    return (
        <section className='space-y-6 mt-14 xl:mt-30 lg:mt-28 md:mt-24 xl:space-y-24 md:space-y-16 '>
            <div className='text-center space-y-3 xl:w-[45%] lg:w-[60%] lg:space-y-4 md:w-4/6 mx-auto'>
                <h1 className='lg:text-[28px] md:text-2xl font-bold'>Connect with us on various channels.</h1>
