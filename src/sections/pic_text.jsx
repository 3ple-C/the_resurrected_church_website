    ...
    return (
        <main className='space-y-16 mt-14 xl:mt-30 lg:mt-28 md:mt-24 xl:space-y-28 lg:space-y-36 md:space-y-32'>
            <section className='w-full flex flex-col gap-14 md:flex-row md:gap-1 md:px-20 py-2'>
                <div className='px-4 space-y-3 xl:w-[52%] xl:space-y-4 lg:w-[80%] md:w-[100%] md:px-1.5 md:py-0.5 md:space-y-2  '>
                    ...
                    <ul className='space-y- font-medium leading-8  text-[15px]'>
                ...
                <div>
                    <div className='px-4 md:px-1.5 text-center'>
            ...
            <section className='w-full flex flex-col gap-14 md:flex-row md:gap-1 md:px-20 py-2'>
                <div className='order-1 md:order-2 px-4 md:px-1'>
                    <div className='w- text-center'>
                        <img src={mission} alt="rtc vision" className='w- max-w- object-contain p-1' />
                    </div>
                </div>

                <div className='w-[100%] px-4 space-y-3 xl:w-[50%] xl:space-y-4 lg:w-[80%] md:order-2  md:w-[100%] md:px-1.5 md:py-0.5 md:space-y-2 '>
                    <h3 className='text-base font-bold text-[#01385F]'>Our call and Goal</h3>
                    <h1 className='xl:text-4xl text-3xl font-semibold'>Our Mission</h1>
                    <ul className='space-y- pt-2 md:pt-0 font-medium leading-8  text-[15px] lg:text-'>
                        <li className='flex gap-2'>
