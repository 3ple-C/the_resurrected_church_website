    ...
    return (
        <section className='space-y-12 pt-16 xl:space-y-20 md:space-y-16 xl:pt-30 lg:pt-28 md:pt-24 pb-6'>
            <div className='text-center space-y-3  xl:w-[58%] lg:w-[60%] lg:space-y-4 md:w-4/6 mx-auto'>
                ...
                <p className='font-medium text-base px-4 sm:text-base'>Explore our collection of inspirational sermons and messages that offer spiritual guidance and upliftment. Listen online at your convenience.</p>
            </div>
